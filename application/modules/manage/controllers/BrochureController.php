    ...
    class BrochureController extends CommonController
    {
        ...
        public function brochure_addAction()
        {
            ...
            if ($request->isPost()) {
                ...
                if ($brochure_info) {
                    return $this->showMessage('恭喜您，添加画册成功。', '/manage/brochure/list');
                } else {
                    return $this->showWarning('对不起，添加画册失败。');
                }
            }
        ...
        public function brochure_editAction()
        {
            ...
            if ($request->isPost()) {
                ...
                if (isset($brochure_update_info) && is_numeric($brochure_update_info)) {
                    return $this->showMessage('恭喜您,修改画册成功。', '/manage/brochure/list');
                } else {
                    return $this->showWarning('对不起，修改画册失败。');
                }
            }
        ...
        public function brochure_delAction()
        {
            ...
            if ($brochure_update_info) {
                return $this->showMessage('恭喜您，删除成功。', '/manage/brochure/list');
            } else {
                return $this->showWarning('很遗憾，删除失败。', '/manage/brochure/list');
            }
        }
